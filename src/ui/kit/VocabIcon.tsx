...
const Face = ({ mood }: { mood: 'happy' | 'sad' }) => (
  <G>
    <Circle cx={24} cy={24} r={19} fill={mood === 'happy' ? '#E0A800' : '#7C93C4'} />
    <Circle cx={24} cy={23} r={18} fill={mood === 'happy' ? palette.safetyYellow : '#A9BEE6'} />
    <Circle cx={17.5} cy={20} r={3} fill={NAVY} />
    <Circle cx={30.5} cy={20} r={3} fill={NAVY} />
    <Circle cx={18.6} cy={19} r={1.1} fill="#FFFFFF" />
    <Circle cx={31.6} cy={19} r={1.1} fill="#FFFFFF" />
    {mood === 'happy' ? (
...
function Art({ id }: { id: string }) {
  switch (id) {
    ...
    case 'milk':
      return (
        <G>
          <Path d="M 14 16 L 24 6 L 34 16 L 34 40 A 4 4 0 0 1 30 44 L 18 44 A 4 4 0 0 1 14 40 Z" fill="#DCE2F0" />
          <Path d="M 15.4 16.6 L 24 8 L 32.6 16.6 L 32.6 39.4 A 3 3 0 0 1 29.6 42.4 L 18.4 42.4 A 3 3 0 0 1 15.4 39.4 Z" fill="#FFFFFF" />
          <Rect x={17} y={24} width={14} height={12} rx={3} fill="#4FA3F7" />
          <Path d="M 20 30 q 4 -5 8 0 q -4 5 -8 0 z" fill="#FFFFFF" />
          <Path d="M 18 12 L 24 7 L 30 12" stroke="#B4BCD4" strokeWidth={2} fill="none" strokeLinecap="round" />
        </G>
      );
    case 'apple':
      return (
    ...
    case 'egg':
      return (
        <G>
          <Path d="M 24 5 C 33 5 40 18 40 28 A 16 16 0 0 1 8 28 C 8 18 15 5 24 5 Z" fill="#E6E9F2" />
          <Path d="M 24 7 C 32 7 38 19 38 28 A 14 14 0 0 1 10 28 C 10 19 16 7 24 7 Z" fill="#FFFFFF" />
          <Ellipse cx={17} cy={22} rx={4} ry={6} fill="#FFF6E5" transform="rotate(-16 17 22)" />
        </G>
      );
    case 'flour':
      return (
        <G>
          <Path d="M 11 18 L 37 18 L 40 40 A 4 4 0 0 1 36 44 L 12 44 A 4 4 0 0 1 8 40 Z" fill="#E6DCC4" />
          <Path d="M 12.4 19.4 L 35.6 19.4 L 38.4 39.6 A 3 3 0 0 1 35.4 42.6 L 12.6 42.6 A 3 3 0 0 1 9.6 39.6 Z" fill="#FFF6E5" />
          <Path d="M 14 18 C 14 12 20 8 24 8 C 28 8 34 12 34 18 Z" fill="#E6DCC4" />
          <Rect x={15} y={26} width={18} height={11} rx={3} fill="#F5D9A6" />
          <Path d="M 19 33 q 5 -6 10 0" stroke="#B9762F" strokeWidth={2.2} strokeLinecap="round" fill="none" />
          <Circle cx={19} cy={13} r={2} fill="#FFFFFF" />
          <Circle cx={29} cy={12} r={1.6} fill="#FFFFFF" />
        </G>
      );
    case 'butter':
      return (
    ...
    case 'sugar':
      return (
        <G>
          <Rect x={6} y={24} width={17} height={17} rx={3.5} fill="#DCE2F0" />
          <Rect x={6} y={24} width={17} height={14} rx={3.5} fill="#FFFFFF" />
          <Rect x={25} y={24} width={17} height={17} rx={3.5} fill="#DCE2F0" />
          <Rect x={25} y={24} width={17} height={14} rx={3.5} fill="#FFFFFF" />
          <Rect x={15} y={7} width={17} height={17} rx={3.5} fill="#DCE2F0" />
          <Rect x={15} y={7} width={17} height={14} rx={3.5} fill="#FFFFFF" />
          <Rect x={18} y={10} width={6} height={3} rx={1.5} fill="#EDF0F8" />
        </G>
      );
    case 'strawberry':
      return (
    ...
    case 'bunny':
      return (
        <G>
          <Ellipse cx={17} cy={12} rx={5} ry={11} fill="#DCE2F0" transform="rotate(-9 17 12)" />
          <Ellipse cx={31} cy={12} rx={5} ry={11} fill="#DCE2F0" transform="rotate(9 31 12)" />
          ...
          <Circle cx={24} cy={31} r={14} fill="#DCE2F0" />
          <Circle cx={24} cy={30} r={13} fill="#FFFFFF" />
    ...
    case 'cloud':
      return (
        <G>
          <Path d="M 13 34 A 9 9 0 0 1 13 16 A 12 12 0 0 1 35 16 A 9 9 0 0 1 35 34 Z" fill="#DCE2F0" />
          <Path d="M 13.6 32.4 A 7.6 7.6 0 0 1 14 17.6 A 10.6 10.6 0 0 1 34 17.6 A 7.6 7.6 0 0 1 34.4 32.4 Z" fill="#FFFFFF" />
        </G>
      );
    case 'rain':
      return (
        <G>
          <Path d="M 13 28 A 8 8 0 0 1 13 12 A 11 11 0 0 1 34 12 A 8 8 0 0 1 34 28 Z" fill="#C6CDE0" />
          <Path d="M 13.6 26.6 A 6.8 6.8 0 0 1 14 13.4 A 9.6 9.6 0 0 1 33 13.4 A 6.8 6.8 0 0 1 33.4 26.6 Z" fill="#EDF0F8" />
          {([
            [15, 32],
            [24, 35],
            [33, 32],
