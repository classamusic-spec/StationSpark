...
export const logicGames: Registry = {
  ...
  'vocab-tap': {
    ...
    meta: {
      ...
      blurb: 'Captain Bea says a word in English or Spanish — tap the picture that matches.',
  ...
  'listen-count': {
    ...
    meta: {
      ...
      blurb: 'Captain Bea asks in Spanish — count the right number of things into the crate.',
  ...
  'word-builder': {
    ...
    meta: {
      ...
      blurb: 'Captain Bea says a word — build it letter by letter, in English or in Spanish.',
