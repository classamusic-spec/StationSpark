  ...
  beats: [
    {
      ...
      lines: [
        ...
        radio('Story time starts in ten minutes. Quick now.'),
      ],
    },
    {
      type: 'minigame',
      ...
      outro: [radio('Packed! Nobody reads in the dark tonight.')],
    },
    {
      type: 'minigame',
      game: 'dispatch-decoder',
      challenge: (ctx) => dispatchDecoderFor('sentence', inScene(ctx, 'library')),
      intro: [radio('Maya wrote a note. Read it with me.')],
    ...
    },
    {
      ...
      outro: [radio('Order locked in. Doors open!')],
    },
    { type: 'travel', from: 'station', to: 'library' },
    {
      ...
      lines: [
        ...
        radio('La tormenta means the storm!', 'La tormenta.'),
    ...
    },
    {
      ...
      intro: [radio('Every shelf has a number. Find the match!')],
    ...
    },
    {
      ...
      intro: [radio('Climb the shelf ladder. Hop to the fuse box.')],
